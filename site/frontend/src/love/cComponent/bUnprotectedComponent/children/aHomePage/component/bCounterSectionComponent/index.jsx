              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#420516] dark:bg-[#C996CC] text-[#C996CC] dark:text-[#420516] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#C996CC] dark:bg-[#420516] text-[#420516] dark:text-[#C996CC] flex-shrink-0">
