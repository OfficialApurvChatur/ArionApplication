              ...
              return (
                <React.Fragment key={index} >
                  <div className="p-4 md:w-1/2">
                    <div className="flex rounded-lg h-full bg-[#420516] dark:bg-[#C996CC] text-[#C996CC] dark:text-[#420516] bg-opacity-60 p-8 flex-col">
                      <div className="flex items-center mb-3">
                        <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-[#C996CC] dark:bg-[#420516] text-[#420516] dark:text-[#C996CC] flex-shrink-0">
