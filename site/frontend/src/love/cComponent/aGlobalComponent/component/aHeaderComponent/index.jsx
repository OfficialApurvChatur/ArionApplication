...
function HeaderComponent({ Redux, LogoutAPICall }) {
  return (
    ...
    <React.Fragment>
      <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-[#C996CC]/60 dark:supports-[backdrop-filter]:bg-[#420516]/60 text-[#420516] dark:text-[#C996CC]">
