    ...
    <>
      <Card 
        className={`
          ...
          bg-[#C996CC] dark:bg-[#420516]
          border-[#420516] dark:border-[#C996CC]
          text-[#420516] dark:text-[#C996CC]`}
      >
        <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-[#420516] dark:border-[#C996CC]">
        ...
        <CardFooter className="py-2 border-y border-[#420516] dark:border-[#C996CC] bottom-0">
          <form className="flex w-full items-center space-x-2">
            <Input
              id="message"
              placeholder="Type your message..."
              className="flex-1 border-[#420516] dark:border-[#C996CC]"
              autoComplete="off"
              value={input}
