...
import { BRANCH_CREATED } from "@/love/iSocket/event";

const APIs = {
  CreateAPI: (Redux, ReduxUltimate, navigate, toast, socket) => {
    loading(ReduxUltimate, true)

    API.ContentAPI.SidebarAPI.MainAPI.SubSubBranchAPI.CreateAPI({
			data: {
    ...
    .then(response => {
      ...
      if (serverResponse.success === true) {
        ...
        socket.emit(BRANCH_CREATED, serverResponse.create);	
