    ...
    .then(response => {
      ...
      if (serverResponse.success === true) {
        Redux.dispatch({ type: Redux.action.ReceivedObject, payload: {
              ...
              retrieve: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProgramRoute.RetrieveRoute}/${each._id}`,
              update: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProgramRoute.UpdateRoute}/${each._id}`,
              delete: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProgramRoute.DeleteRoute}/${each._id}`,
						}
					})
				} })
      }
