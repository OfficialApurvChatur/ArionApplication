  ...
  return (
    {
      header: {
        ...
        buttons: [
          {
            label: "Delete",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.BlogRoute.DeleteRoute}/${id}`
          },
        ]
      },
      component: "Create",
              ...
              inputs: [
                {
                  ...
                  options: Redux.state.RequiredObject?.BlogCardList?.map(each => {
                      return (
                        { label: each.title, value: each.id }
                      )
                    }),
                  value: Redux.state.FormObject.FormValue?.blogCards
                },
              ],  
            },
            {
