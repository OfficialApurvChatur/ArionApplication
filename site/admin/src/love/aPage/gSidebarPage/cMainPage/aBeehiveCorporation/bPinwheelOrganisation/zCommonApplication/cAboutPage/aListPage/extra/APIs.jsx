...
const APIs = {
  ListAPI: (Redux, ReduxUltimate) => {
    ...
    API.ContentAPI.SidebarAPI.MainAPI.AboutAPI.ListAPI()
    .then(response => {
      ...
      if (serverResponse.success === true) {
        Redux.dispatch({ type: Redux.action.ReceivedObject, payload: {
              ...
              retrieve: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.AboutRoute.RetrieveRoute}/${each._id}`,
              update: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.AboutRoute.UpdateRoute}/${each._id}`,
              delete: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.AboutRoute.DeleteRoute}/${each._id}`,
						}
					})
				} })
      }
