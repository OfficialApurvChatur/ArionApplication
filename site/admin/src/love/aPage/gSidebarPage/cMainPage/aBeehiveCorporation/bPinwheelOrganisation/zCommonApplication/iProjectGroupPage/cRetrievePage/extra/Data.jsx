...
const Data = (Redux, id) => {
  return (
    {
      header: {
        label: "Project Group Retrieve",
        buttons: [
          {
            label: "Update",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProjectGroupRoute.UpdateRoute}/${id}`
          },
          {
            label: "Delete",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProjectGroupRoute.DeleteRoute}/${id}`
          },
        ]
      },
      component: "Retrieve",
              ...
              values: [
                {
                  type: "links3",
                  label: "Projects",
                  value: Redux.state.ReceivedObject?.Retrieve["projects"]
                },
              ],  
            },
            {
