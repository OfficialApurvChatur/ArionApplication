...
import { BRANCH_SECTION_CREATED } from "@/love/iSocket/event";

const APIs = {
  CreateAPI: (Redux, ReduxUltimate, navigate, toast, socket) => {
    loading(ReduxUltimate, true)

    API.ContentAPI.SidebarAPI.MainAPI.BranchAPI.CreateAPI({
			data: {
    ...
    .then(response => {
      ...
      if (serverResponse.success === true) {
        ...
        socket.emit(BRANCH_SECTION_CREATED, serverResponse.create);	
