...
const APIs = {
  ListAPI: (Redux, ReduxUltimate) => {
    ...
    API.ContentAPI.SidebarAPI.MainAPI.EventAPI.ListAPI()
    .then(response => {
      ...
      if (serverResponse.success === true) {
        Redux.dispatch({ type: Redux.action.ReceivedObject, payload: {
              ...
              retrieve: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.EventRoute.RetrieveRoute}/${each._id}`,
              update: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.EventRoute.UpdateRoute}/${each._id}`,
              delete: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.EventRoute.DeleteRoute}/${each._id}`,
						}
					})
				} })
      }
