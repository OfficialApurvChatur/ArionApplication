  ...
  return (
    {
      header: {
        ...
        buttons: [
          {
            label: "Delete",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.EventRoute.DeleteRoute}/${id}`
          },
        ]
      },
      component: "Create",
              ...
              inputs: [
                {
                  ...
                  options: Redux.state.RequiredObject?.EventCardList?.map(each => {
                      return (
                        { label: each.title, value: each.id }
                      )
                    }),
                  value: Redux.state.FormObject.FormValue?.eventCards
                },
              ],  
            },
            {
