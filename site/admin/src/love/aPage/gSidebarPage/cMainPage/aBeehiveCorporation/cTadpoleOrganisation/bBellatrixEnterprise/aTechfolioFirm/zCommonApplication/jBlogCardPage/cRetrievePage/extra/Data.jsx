...
const Data = (Redux, id) => {
  return (
    {
      header: {
        label: "Blog Card Retrieve",
        buttons: [
          {
            label: "Update",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.BlogCardRoute.UpdateRoute}/${id}`
          },
          {
            label: "Delete",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.BlogCardRoute.DeleteRoute}/${id}`
          },
        ]
      },
      component: "Retrieve",
