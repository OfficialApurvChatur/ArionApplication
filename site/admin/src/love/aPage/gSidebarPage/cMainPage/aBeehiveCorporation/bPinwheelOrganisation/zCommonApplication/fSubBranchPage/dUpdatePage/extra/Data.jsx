        ...
        create: {
          cards: [
            ...
            },
            {
              ...
              inputs: [
                {
                  label: "Sub Sub Branch",
                  placeholder: "Sub Sub Branch",
                  type: "checkbox",
                  name: "subSubBranches",
                  onChange: event => handleCheckboxInput(event, Redux),
                  options: Redux.state.RequiredObject?.SubSubBranchList?.map(each => {
                      return (
                        { label: each.title, value: each.id }
                      )
                    }),
                  value: Redux.state.FormObject.FormValue?.subSubBranches
                },
              ],  
            },
            {
