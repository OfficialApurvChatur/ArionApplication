...
const APIs = {
  ListAPI: (Redux, ReduxUltimate) => {
    ...
    API.ContentAPI.SidebarAPI.MainAPI.ProjectSectionAPI.ListAPI()
    .then(response => {
      ...
      if (serverResponse.success === true) {
        Redux.dispatch({ type: Redux.action.ReceivedObject, payload: {
              ...
              retrieve: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProjectSectionRoute.RetrieveRoute}/${each._id}`,
              update: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProjectSectionRoute.UpdateRoute}/${each._id}`,
              delete: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ProjectSectionRoute.DeleteRoute}/${each._id}`,
						}
					})
				} })
      }
