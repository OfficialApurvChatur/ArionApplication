...
const Data = (Redux, id) => {
  return (
    {
      header: {
        label: "Branch Retrieve",
        buttons: [
          {
            label: "Update",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.BranchRoute.UpdateRoute}/${id}`
          },
          {
            label: "Delete",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.BranchRoute.DeleteRoute}/${id}`
          },
        ]
      },
      component: "Retrieve",
              ...
              values: [
                {
                  type: "links3",
                  label: "Branch Groups",
                  value: Redux.state.ReceivedObject?.Retrieve["subBranches"]
                },
              ],  
            },
            {
