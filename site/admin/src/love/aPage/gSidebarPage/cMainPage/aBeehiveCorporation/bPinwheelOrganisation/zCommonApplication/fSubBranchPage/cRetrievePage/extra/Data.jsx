...
const Data = (Redux, id) => {
  return (
    {
      header: {
        label: "Sub Branch Retrieve",
        buttons: [
          {
            label: "Update",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.SubBranchRoute.UpdateRoute}/${id}`
          },
          {
            label: "Delete",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.SubBranchRoute.DeleteRoute}/${id}`
          },
        ]
      },
      component: "Retrieve",
              ...
              values: [
                {
                  type: "links3",
                  label: "Branches",
                  value: Redux.state.ReceivedObject?.Retrieve["subSubBranches"]
                },
              ],  
            },
            {
