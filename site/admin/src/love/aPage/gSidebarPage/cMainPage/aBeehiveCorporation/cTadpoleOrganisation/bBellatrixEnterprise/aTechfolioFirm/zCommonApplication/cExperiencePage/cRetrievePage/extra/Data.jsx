...
const Data = (Redux, id) => {
  return (
    {
      header: {
        label: "Experience Retrieve",
        buttons: [
          {
            label: "Update",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ExperienceRoute.UpdateRoute}/${id}`
          },
          {
            label: "Delete",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.MainRoute.ExperienceRoute.DeleteRoute}/${id}`
          },
        ]
      },
      component: "Retrieve",
