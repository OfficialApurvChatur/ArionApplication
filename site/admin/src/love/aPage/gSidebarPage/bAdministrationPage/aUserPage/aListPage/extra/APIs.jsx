...
const APIs = {
  ListAPI: (Redux, ReduxUltimate) => {
    ...
    API.ContentAPI.SidebarAPI.AdministrationAPI.UserAPI.ListAPI()
    .then(response => {
      ...
      if (serverResponse.success === true) {
        Redux.dispatch({ type: Redux.action.ReceivedObject, payload: {
              ...
              retrieve: `${FinalRouteName.ContentRoute.SidebarRoute.AdministrationRoute.UserRoute.RetrieveRoute}/${each._id}`,
              update: `${FinalRouteName.ContentRoute.SidebarRoute.AdministrationRoute.UserRoute.UpdateRoute}/${each._id}`,
              delete: `${FinalRouteName.ContentRoute.SidebarRoute.AdministrationRoute.UserRoute.DeleteRoute}/${each._id}`,
						}
					})
				} })
      }
