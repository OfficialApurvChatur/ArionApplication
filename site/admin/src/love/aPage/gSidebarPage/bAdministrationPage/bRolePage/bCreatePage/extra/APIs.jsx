...
import { ROLE_CREATED } from "@/love/iSocket/event";

const APIs = {
  CreateAPI: (Redux, ReduxUltimate, navigate, toast, socket) => {
    loading(ReduxUltimate, true)

    API.ContentAPI.SidebarAPI.AdministrationAPI.RoleAPI.CreateAPI({
			data: {
    ...
    .then(response => {
      ...
      if (serverResponse.success === true) {
        ...
        socket.emit(ROLE_CREATED, serverResponse.create);	
