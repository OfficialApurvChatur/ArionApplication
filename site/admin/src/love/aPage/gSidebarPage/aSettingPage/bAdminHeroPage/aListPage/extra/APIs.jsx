...
const APIs = {
  ListAPI: (Redux, ReduxUltimate) => {
    ...
    API.ContentAPI.SidebarAPI.SettingAPI.AdminHeroAPI.ListAPI()
    .then(response => {
      ...
      if (serverResponse.success === true) {
        Redux.dispatch({ type: Redux.action.ReceivedObject, payload: {
              ...
              retrieve: `${FinalRouteName.ContentRoute.SidebarRoute.SettingRoute.AdminHeroRoute.RetrieveRoute}/${each._id}`,
              update: `${FinalRouteName.ContentRoute.SidebarRoute.SettingRoute.AdminHeroRoute.UpdateRoute}/${each._id}`,
              delete: `${FinalRouteName.ContentRoute.SidebarRoute.SettingRoute.AdminHeroRoute.DeleteRoute}/${each._id}`,
						}
					})
				} })
      }
