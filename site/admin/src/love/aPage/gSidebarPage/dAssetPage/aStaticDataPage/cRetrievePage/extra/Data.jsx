...
const Data = (Redux, id) => {
  return (
    {
      header: {
        label: "Static Data Retrieve",
        buttons: [
          {
            label: "Update",
            route: `${FinalRouteName.ContentRoute.SidebarRoute.AssetRoute.StaticDataRoute.UpdateRoute}/${id}`
          },
          {
            label: "Delete",
              ...
              values: [
                {
                  type: "cards1",
                  label: "Cards",
                  value: Redux.state.ReceivedObject?.Retrieve["cards"]
                },
              ],  
            },
          ],
